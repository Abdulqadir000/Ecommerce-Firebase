...
const BuyNowModal = ({ addressInfo, setAddressInfo, buyNowFunction }) => {
  ...
  return (
    <>
      ...
      <Dialog open={open} handler={handleOpen} className=" bg-gray-200">
        <DialogBody className="">
          <div className="mb-3">
            <input
              ...
              className="bg-gray-50 border border-gray-400 px-2 py-2 w-full rounded-md outline-none text-gray-600 placeholder-gray-600"
            />
          </div>
          <div className="mb-3">
            <input
