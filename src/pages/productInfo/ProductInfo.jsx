                ...
                <div className="w-full px-4 md:w-1/2">
                  <div className="lg:pl-20">
                    ...
                    {/* <div className="flex gap-4 mb-6">
                      <button className="w-full px-4 py-3 text-center text-gray-100 bg-blue-600 border border-transparent dark:border-gray-700 hover:border-blue-500 hover:text-blue-700 hover:bg-blue-100 rounded-xl">
                        Buy now
                      </button>
                    </div> */}
                  </div>
